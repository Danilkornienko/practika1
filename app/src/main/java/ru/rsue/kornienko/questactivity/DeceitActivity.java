...
public class DeceitActivity extends AppCompatActivity {
    public static final String EXTRA_ANSWER_IS_TRUE = "ru.rsue.kornienko.questactivity.answer_is_true";
    public static final String EXTRA_ANSWER_SHOWN = "ru.rsue.kornienko.questactivity.answer_is_shown";
